...
def test_dynamic_topology_and_edge_positions() -> None:
    ...
    points = measured_points(
        {"layer1": {"left": {"0": {"r": 1, "g": 2, "b": 3}, "1": {"r": 4, "g": 5, "b": 6}}, "top": {"0": {"r": 7, "g": 8, "b": 9}}}}, topology
    )
